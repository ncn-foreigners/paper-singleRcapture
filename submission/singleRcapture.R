...
popSizeEst(basicModel)    #basicModel$populationSize
popSizeEst(modelInflated) #modelInflated$populationSize
...
## marginal frequencies for basic model
margFreq <- marginalFreq(basicModel)
summary(margFreq, df = 1, dropl5 = "group")


##  marginal frequencies for inflated model
...
## estimation by strata for basic model
...
## estimation by strata for inflated model
