...
literatura: 
+ odwołania do capture-recapture
+ odwołania do badań społecznych ale też badan z zakresu biostatystyki
+ odwołania do prac Boheninga i jego książek 
+ ogólnie teoria od zero-truncated, przez rozszerzenia po ziot i inne
\allowdisplaybreaks
-->
