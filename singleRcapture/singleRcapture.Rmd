...
We have created a number of classes: the main one: \code{singleRStaticCountData}, \code{singleRfamily} and supplementary: \code{popSizeEstResults}, \code{summarysingleRStaticCountData} and \code{summarysingleRmargin}, which make it possible to extract relevant information regarding the population size. 
