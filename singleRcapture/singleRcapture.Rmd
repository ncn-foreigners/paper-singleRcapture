...
methods as well as diagnostics plots (e.g. rootograms) with parameters
...
incarceration). Recently, ... introduced one-inflated distributions that
explicitly model probability of the singletons given by ...
