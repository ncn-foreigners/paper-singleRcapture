...
In the replication materials we provide a possible way of implementing the above model, with \code{lambda, pi} meaning $\frac{1}{2}\lambda,\frac{1}{2}\pi$. We provide a simple example that shows that the proposed approach works as expected.
