...
```
The next sections are dedicated to a detailed description of how one can assess the results using standard statistical tests and diagnostics beyond just the likelihood ratio test.
