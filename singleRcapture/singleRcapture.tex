...
inherits the \code{family} class from \pkg{stats} and has explictly
...
\begin{itemize}
  ...
  \item \code{simulate} -- which calls \code{simulate} method for the chosen model and fitted $\boldsymbol{\eta}$.
...
\code{estimatePopsizeFit} function}\label{estimatePopsizeFit-function}
