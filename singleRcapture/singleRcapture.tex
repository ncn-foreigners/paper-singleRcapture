...
\begin{itemize}
  ...
  \item \code{boot} -- If bootstrap was performed a numeric vector containing the $\hat{N}$ values from the bootstrap, a character vector with value \code{"No bootstrap performed"} otherwise.
...
\begin{center}\includegraphics{singleRcapture_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{center}\includegraphics{singleRcapture_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\hypertarget{takeaways-of-different-models}{%
