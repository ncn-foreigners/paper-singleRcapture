...
to use the \code{sec-estimatePopsizeFit} function that may be useful for
...
\tightlist
\item
  We fill the first \(n\) rows with \code{model.matrix} according to the
...
\tightlist
\item
  We use \code{estimatePopsizeFit} function to fit the model assuming
