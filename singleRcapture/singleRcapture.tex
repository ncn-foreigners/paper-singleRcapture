...
how to use the \code{estimatePopsizeFit} function which is aimed to
mimic the \code{glm.fit} or similar functions. This option could be of
...
\code{popSizeEstResults}, \code{summarysingleRStaticCountData} and
\code{summarysingleRmargin}, which make it possible to extract relevant
