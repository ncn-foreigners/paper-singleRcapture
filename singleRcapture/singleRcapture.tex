...
of the \(\omega\) inflation parameter (in \code{ziot*} or \code{oizt*})
is more convenient that the interpretation of the \(\pi\) probability
...
Algorithm \ref{algo-semipar-boot}.
...
R> 
R> knitr::kable(pop_size_stratas[, cols],  col.names = cols_custom, digits=2)
\end{CodeInput}
...
+ )
R> 
R> knitr::kable(pop_size_stratas_custom[, cols], col.names = cols_custom, digits=2)
\end{CodeInput}
