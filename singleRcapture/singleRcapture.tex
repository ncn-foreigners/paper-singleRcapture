...
incarceration). Therefore, \citet{godwin2017estimation} and
...
for singletons as presented below

\[
\mathbb{P}^{\ast}[Y=y|Y>0]=\omega\mathcal{I}_{\{1\}}(y)+(1-\omega)\mathbb{P}[Y=y|Y>0],
\] where \ldots{} which can be further plug-in in the estimator
\eqref{eq-ht-estimator}. For recent review see \citet{bohning2024one}.
